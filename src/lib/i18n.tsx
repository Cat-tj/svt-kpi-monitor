...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "enterprise_access": "Enterprise access only. Contact IT for credentials.",
    "search_placeholder": "Search KPIs, departments...",
  },
  id: {
    "dashboard": "Dasbor",
    "my_kpis": "KPI Saya",
    ...
    "enterprise_access": "Akses khusus karyawan. Hubungi IT untuk kredensial.",
    "search_placeholder": "Cari KPI, departemen...",
  },
};
